  ...
  return (
    <section className="bg-[#F4F4F4]">
      <div className="lg:grid lg:grid-cols-2 pb-8 lg:gap-16 lg:max-w-[69rem] lg:mx-auto lg:justify-items-center lg:items-center lg:py-12 ">
        ...
        <article className="px-6 pt-8 space-y-4">
          <h4 className="font-bold text-3xl">
            Explore the new BMW
            <br /> interior
          </h4>
          <p className="text-left text-base lg:text-xs suggestion-text">
          ...
          {width !== undefined && (
            <Button
              ...
              style="bg-[#15f4ee] text-center py-4 block rounded-md cursor-pointer text-[#040C0C] font-semibold text-lg lg:w-[14rem] lg:text-sm lg:py-3 hover:text-[#15f4ee] hover:bg-[#040C0C]"
            />
          )}
        </article>
      </div>
